...
namespace Shared
{
    public abstract class Channel<TProtocol, TMessageType> : IDisposable where TProtocol : Protocol<TMessageType>, new()
    {
        ...
        protected virtual async Task ReceiveLoop()
        {
            while(!_cancellationTokenSource.Token.IsCancellationRequested)
            {
                ...
                await _messageCallback((TMessageType)msg ).ConfigureAwait(false);
            }
        }
